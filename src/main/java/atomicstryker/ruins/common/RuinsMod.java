...
public class RuinsMod
{
    ...
    public void load(FMLInitializationEvent evt)
    {
        ...
        RuinsWorldGenerator worldGen = new RuinsWorldGenerator();
    ...
    private class RuinsWorldGenerator implements ICubicPopulator, IWorldGenerator
    {
        @Override
        public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
            internalGenerate(random, chunkX, 0, chunkZ, world, null, null);
        }
        ...
        private void generate(World world, Random random, CubePos pos, Biome biome, CubePopulatorEvent event) {
            int chunkX = pos.chunkPos().x;
            int chunkZ = pos.chunkPos().z;

            internalGenerate(random, chunkX, pos.getY(), chunkZ, world, null, null);
        }

        private void internalGenerate(Random random, int chunkX, int chunkY, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
            ...
            if (wh != null) {
                int[] tuple = {chunkX, chunkY, chunkZ};
                if (wh.currentlyGenerating.contains(tuple)) {
                    ...
                    if (wh.fileHandle.allowsDimension(world.provider.getDimension()) && !wh.chunkLogger.catchChunkBug(chunkX, chunkZ)) {
                        ...
                        if (world.provider instanceof WorldProviderHell) {
                            generateNether(world, random, tuple[0] * 16, tuple[1] * 16, tuple[2] * 16);
                        } else
                        // normal world
                        {
                            generateSurface(world, random, tuple[0] * 16, tuple[1] * 16, tuple[2] * 16);
                        }
    ...
    private void generateNether(World world, Random random, int chunkX, int chunkY, int chunkZ)
    {
        ...
        if (wh.fileHandle != null)
        {
            ...
            wh.generator.generateNether(world, random, chunkX, chunkY, chunkZ);
        }
    }

    private void generateSurface(World world, Random random, int chunkX, int chunkY, int chunkZ)
    {
        WorldHandle wh = getWorldHandle(world);
        if (wh.fileHandle != null)
        {
            ...
            wh.generator.generateNormal(world, random, chunkX, chunkY, chunkZ);
        }
    }
